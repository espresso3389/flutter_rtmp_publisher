...
package jp.espresso3389.video_overlay_player;
...
public class FrameAndMaskToRgbaSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener {
  ...
  FrameAndMaskToRgbaSurfaceTexture(SurfaceTexture surfaceTextureDest) {
  ...
  private static class STextureRender {
    ...
    private final float[] mTriangleVerticesData = {
      // upper-half
      // X, Y, Z, U, V
      -1.0f, -1.0f, 0, 0.0f, 0.5f,
       1.0f, -1.0f, 0, 1.0f, 0.5f,
    ...
    private static final String FRAGMENT_SHADER =
      "#extension GL_OES_EGL_image_external : require\n" +
        ...
        "  vec4 mask = texture2D(sTexture, vTextureCoord + vec2(0.0, 0.5));\n" +
        "  gl_FragColor = rgba * mask.x;\n" +
        "}\n";
